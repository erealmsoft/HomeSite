...
angular.module('erealm')
    .config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('cn', {
            ...
            "love_one" : "我们是技术控，喜欢软件开发并且不断努力地进步。我们喜欢阅读各种技术站点和参加各种线上或线下的技术会议。不断的技术学习和交流使得团队技术保持领先。",
            "love_two" : "我们喜欢解决问题。我们模拟，设计并且开发企业级的应用解决方案。它可以帮助我们管理上百台服务器以及上百万用户的数据，将不同的业务及各地组织或政府连接起来。",
            "love_three" : "我们使用 Node.js, Asp.net, JSP，HTML5等技术来构建网站。我们使用Windows Form，WPF，MFC等技术开发桌面应用。我们使用我们使用Object C，Swift，Java等语言来构建移动应用。",
            "love_four" : "我们喜欢作为一个专业的团队来直接跟您一起工作，开发您的产品。我们喜欢沟通并善于归纳您的想法。我们的团队已经成功开发了几十个大中型项目，软件的使用者遍布二十几个国家超过了一百多万人。",
            "touch_us" : "联系我们 ?",
