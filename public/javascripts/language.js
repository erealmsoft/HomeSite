...
angular.module('erealm')
    .config(['$translateProvider', function ($translateProvider) {
        ...
        $translateProvider.translations('cn', {
            ...
            "love_two" : "我们善于解决问题，一直专注于提供企业级的应用解决方案。帮助您轻松管理上百台服务器和上百万用户的数据，合理实行不同业务的系统整合。",
            "love_three" : "我们擅长使用 Node.js, ASP.NET, JSP，HTML5等技术来构建网站,使用Windows Form，WPF，MFC等技术开发桌面应用,使用Object C，Swift，Java等语言来构建移动应用。",
